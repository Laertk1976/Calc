...
export default function useCalculatorStyles() {
  ...
  return useMemo(() => {
    ...
    const overrides = {
      ...
      utilityKeyText: { fontSize: compact ? 14 : 18 },
      ...
      addRowButtonText: { fontSize: compact ? 12 : 16, textAlign: 'center' },
      closeButtonText: { fontSize: compact ? 13 : 16, textAlign: 'center', flexShrink: 1 },
